...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 flex w-[1920px] h-[72px] px-[340px] py-3 justify-between items-center border-b border-[rgba(238,238,238,0.2)] bg-[rgba(86,44,44,0.7)] backdrop-blur-[7.5px] z-50">
      <div className="flex justify-between items-center w-full">
        {/* Logo */}
        <div className="flex items-center">
          <a href={getLangPath('/')} className="text-white font-['Poppins'] text-[15px] font-bold">
            POULOGO
          </a>
        </div>
